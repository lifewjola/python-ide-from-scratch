...
# Maximize window on startup in a more compatible way for Linux
root.geometry("800x600")  # Default window size
root.attributes('-zoomed', True)  # Attempt to maximize window on startup, more compatible on Linux
